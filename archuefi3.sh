...
if [[ $prog_set == 1 ]]; then
  sudo pacman -S doublecmd-gtk2 vlc gimp audacity screenfetch vlc qbittorrent galculator --noconfirm
  yay -S cherrytree timeshift flameshot-git sublime-text-dev pamac-aur --noconfirm 
